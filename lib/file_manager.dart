...
// check weather FileSystemEntity is Directory
  ...
  static const List<int> powBase = [1, 1024, 1048576, 1073741824, 1099511627776];
        ...
        return ValueListenableBuilder<SortBy>(
            ...
            builder: (context, snapshot, _) {
              return FutureBuilder<List<FileSystemEntity>>(
                  future: entityList(pathSnapshot, widget.controller.getSortedByNotifier.value),
                  builder: (context, snapshot) {
                    if (snapshot.hasData) {
...
class ControlBackButton extends StatelessWidget {
  const ControlBackButton({required this.child, required this.controller, super.key});
